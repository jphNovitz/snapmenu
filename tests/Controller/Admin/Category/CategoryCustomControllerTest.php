...
class CategoryCustomControllerTest extends WebTestCase
{
    ...
    #[NoReturn] public function test_admin_can_add_a_custom_category(): void
    {
        ...
        $this->client->request('GET', sprintf('%scustom/new', $this->path));
